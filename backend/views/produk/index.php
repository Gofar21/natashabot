...
/** @var common\search\ProdukSearch $searchModel */
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($model) {
                                return Yii::$app->formatter->asCurrency($model->harga, 'idr');
                            }
                        ],
                        [
                            'attribute' => 'produk_kategori.nama',
                            'value' => function ($model) {
                                return $model->produkKategori->nama;
                            }
                        ],
                    ],
                ]); ?>
